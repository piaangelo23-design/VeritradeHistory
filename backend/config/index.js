...
module.exports = {
  ...
  memberBaseline: parseInt(process.env.DISCORD_MEMBER_BASELINE, 10) || 34000,
  visitBaseline: parseInt(process.env.WEBSITE_VISIT_BASELINE, 10) || 90000,
  smallTradeBaseline: parseInt(process.env.SMALL_TRADE_BASELINE, 10) || 2364,
  mediumTradeBaseline: parseInt(process.env.MEDIUM_TRADE_BASELINE, 10) || 2136,
  largeTradeBaseline: parseInt(process.env.LARGE_TRADE_BASELINE, 10) || 1972,
